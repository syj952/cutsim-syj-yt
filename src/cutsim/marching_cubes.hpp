...
public:
    ...
    virtual ~MarchingCubes() { }
     ///added hust
    static std::vector<double> originalPoints;
    static std::vector<double> deformedPoints;
    static bool pointsLoaded;
     ///added hust
   static void loadDeformationData(const std::string& deformedPointsFile, const std::string& displacementsFile);
   void updateFieldValues(Octnode* node, const Volume* vol);
protected:
